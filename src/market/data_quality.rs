...
//!              NonMonotonicTimestamp, EmptyFile
...
impl DataQualityReport {
    ...
    pub fn push_issue(
        ...
        self.issues.push(DataQualityIssue { kind, row, timestamp, message: message.into() });
    }
}
...
mod tests {
    ...
    fn has_errors_true_after_error_issue() {
        ...
        r.push_issue(DataQualityIssueKind::InvalidCandle, Some(2), None, "bad candle");
        assert!(r.has_errors());
    ...
    fn missing_gap_is_warning_not_error() {
        let mut r = make_report();
        r.push_issue(DataQualityIssueKind::MissingCandleGap, None, Some(60_000), "gap");
        assert!(!r.has_errors());
        assert_eq!(r.error_count(), 0);
    ...
    fn error_count_counts_only_errors() {
        let mut r = make_report();
        r.push_issue(DataQualityIssueKind::DuplicateTimestamp, None, Some(0), "dup");
        r.push_issue(DataQualityIssueKind::MissingCandleGap, None, Some(60_000), "gap");
        r.push_issue(DataQualityIssueKind::InvalidNumber, Some(3), None, "bad num");
    ...
    fn missing_gap_record_is_stored() {
        ...
        r.push_issue(DataQualityIssueKind::MissingCandleGap, None, Some(60_000), "2 missing");
